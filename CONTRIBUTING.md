...
If you are having particular problem with your Sqoin instalation, please first [search older
issues](https://github.com/bitpay/sqoin/issues) in order to learn if the issue is already reported. It could be fixed already.

Please also check our [FAQ](https://github.com/bitpay/sqoin/wiki/SQOIN---FAQ).
...
- Which version of Sqoin are you using? (Check Sqoin version on the side menu)
...
- Please check Sqoin logs (General Settings -> About Sqoin -> Session Logs). Look for
...
To open an issue go to [Github Issues](https://github.com/bitpay/sqoin/issues).
...
Please adhere to the coding conventions used throughout Sqoin (indentation, tests, etc.)
