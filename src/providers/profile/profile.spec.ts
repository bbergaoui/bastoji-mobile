...
describe('Profile Provider', () => {
  ...
  const walletFixture = {
    api1: {
      ...
      status: {
        availableBalanceSat: 1000000000 // 10 BTJ
      },
      isComplete: () => {
        return true;
      },
    ...
    api3: {
      ...
      status: {
        availableBalanceSat: 150000000 // 1.50 BTJ
      },
      isComplete: () => {
        return true;
      },
  ...
  class PersistenceProviderMock {
    constructor() {}
    getBalanceCache() {
      return Promise.resolve('0.00 BTJ');
    }
    setWalletOrder() {
