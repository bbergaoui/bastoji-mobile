...
export class SellCoinbasePage {
  ...
  private openFinishModal(): void {
    ...
    let finishComment =
      'The transaction is not yet confirmed, and will show as "Pending" in your Activity. The bastoji sale will be completed automatically once it is confirmed by Coinbase';
