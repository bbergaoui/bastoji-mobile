...
@Component({
  selector: 'page-bastoji-cash',
  templateUrl: 'bastoji-cash.html'
})
export class BastojiCashPage {
  private errors;
  ...
  public openHelpExternalLink(): void {
    let url =
      'https://support.bitpay.com/hc/en-us/articles/115005019583-How-Can-I-Recover-Bastoji-Cash-BCH-from-My-Wallet-';
    let optIn = true;
    let title = null;
