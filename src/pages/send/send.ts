...
export class SendPage {
  ...
  private sendPaymentToAddress(bastojiAddress: string, coin: string): void {
    this.navCtrl.push(AmountPage, { toAddress: bastojiAddress, coin });
  }

  private addToAddressBook(bastojiAddress: string): void {
    this.navCtrl.push(AddressbookAddPage, { addressbookEntry: bastojiAddress });
  }
