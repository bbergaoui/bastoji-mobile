...
var validbase58 = require('./data/bastojid/base58_keys_valid.json');
var invalidbase58 = require('./data/bastojid/base58_keys_invalid.json');
...
describe('Address', function() {
  ...
  describe('bastojid compliance', function() {
  ...
  describe('Cashaddr', function() {
    ...
    //from https://github.com/Bastoji-UAHF/spec/blob/master/cashaddr.md#examples-of-address-translation
    //
    //
    var t = [
      ['CTH8H8Zj6DSnXFBKQeDG28ogAS92iS16Bp', 'bastojicash:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a'],
      ['Cazk5ZxnJGY1iYqqTefvo7ZtwLYx3YzjgY', 'bastojicash:qr95sy3j9xwd2ap32xkykttr4cvcu7as4y0qverfuy'],
      ['CGZpaFRaJYHqohPJ8BKYvKmxffV2dcmmN9', 'bastojicash:qqq3728yw0y47sqn6l2na30mcw6zm78dzqre909m2r'],
      ['HHLN6S9BcP1JLSrMhgD5qe57iVEMFMLCBT', 'bastojicash:ppm2qsznhks23z7629mms6s4cwef74vcwvn0h829pq'],
      ['HR3ytsYEpS6XXkWskgfkccqLVPeGdXQ1S8', 'bastojicash:pr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e'],
      ['H6d4PZ12phrMcu4LRDKNjq3QDiaMDz3fUd', 'bastojicash:pqq3728yw0y47sqn6l2na30mcw6zm78dzq5ucqzc37'],
    ];
    var i;
  ...
  describe('validation', function() {
    ...
    it('isValid returns false on network mismatch on cashaddr', function() {
      var valid = Address.isValid('bastojicash:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a', 'regtest');
      valid.should.equal(false);
    });

    it('isValid returns true on network match on cashaddr', function() {
      var valid = Address.isValid('bastojicash:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a', 'mainnet');
      valid.should.equal(true);
    });
