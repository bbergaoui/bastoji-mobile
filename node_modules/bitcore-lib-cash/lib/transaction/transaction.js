...
/**
 * Retrieve a hexa string that can be used with bastojid's CLI interface
 ...
 * * `disableMoreOutputThanInput`: disable checking if the transaction spends more bastojis than the sum of the input amounts
 * @return {string}
 */
 ...
 *
 * Can receive, as output information, the output of bastojid's `listunspent` command,
 ...
 *
 * // From a pay to public key hash output from bastojid's listunspent
 ...
 *
 * @see {https://github.com/bastoji/bips/blob/master/bip-0069.mediawiki}
 * @return {Transaction} this
 */
 ...
 * CheckTransaction in bastoji core.
 */
...
/**
 * Analogous to bastojid's IsCoinBase function in transaction.h
 */
