...
/**
 * A bastoji transaction script. Each transaction's inputs and outputs
 * has a script that is evaluated to validate it's spending.
 *
 * See https://en.bastoji.it/wiki/Script
 *
 * @constructor
...
/**
 * Analogous to bastojid's FindAndDelete. Find and delete equivalent chunks,
...
/**
 * Comes from bastojid's script interpreter CheckMinimalPush function
...
/**
 * Comes from bastojid's script DecodeOP_N function
 * @param {number} opcode
...
/**
 * Comes from bastojid's script GetSigOpCount(boolean) function
