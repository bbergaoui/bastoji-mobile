...
/**
 * Internal function to transform a bastoji address buffer
 *
 * @param {Buffer} buffer - An instance of a hex encoded address Buffer
 ...
 *
 * The addresses will be sorted lexicographically, as that is the trend in bastoji.
...
/**
 * Internal function to transform a bastoji cash address string
 *
 * @param {string} data
 * @param {String|Network=} network - either a Network instance, 'livenet', or 'testnet'
 * @param {string=} type - The type: 'pubkeyhash' or 'scripthash'
 ...
 *
 * @param {string} str - An string of the bastoji address
 * @param {String|Network=} network - either a Network instance, 'livenet', or 'testnet'
 * @param {string=} type - The type of address: 'script' or 'pubkey'
 * @returns {Address} A new valid and frozen instance of an Address
 */
 ...
 *
 * @returns {Buffer} Bastoji address buffer
 */
 ...
 *
 * @returns {string} Bastoji address
 */
Address.prototype.toString = function() {
  //console.log('Warning: Using deprecated bastoji cash address type. Replace to .toCashAddress');
...
/***
 * @license
 * https://github.com/bastojicashjs/cashaddr
 ...
 *
 * @returns {string} Bastoji Cash address
 */
 ...
 * format: https://github.com/Bastoji-UAHF/spec/blob/master/cashaddr.md.
 *
