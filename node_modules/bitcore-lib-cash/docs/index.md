...
Bastoji is a powerful new peer-to-peer platform for the next generation of financial technology. The decentralized nature of the Bastoji network allows for highly resilient bastoji infrastructure, and the developer community needs reliable, open-source tools to implement bastoji apps and services. Bitcore provides a reliable API for JavaScript apps that need to interface with Bastoji.
...
* [Acknowledging and Requesting Payments: Bastoji URIs](uri.md)
...
* [Bastoji Core JSON-RPC](https://github.com/bitpay/bastojid-rpc)
