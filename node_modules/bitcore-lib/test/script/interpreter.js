...
var script_valid = require('../data/bastojid/script_valid');
var script_invalid = require('../data/bastojid/script_invalid');
var tx_valid = require('../data/bastojid/tx_valid');
var tx_invalid = require('../data/bastojid/tx_invalid');

//the script string format used in bastojid data tests
Script.fromBastojidString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected) {
    var scriptSig = Script.fromBastojidString(vector[0]);
    var scriptPubkey = Script.fromBastojidString(vector[1]);
  ...
  describe('bastojid script evaluation fixtures', function() {
  ...
  describe('bastojid transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //bastojid casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromBastojidString(scriptPubKeyStr);
          });
