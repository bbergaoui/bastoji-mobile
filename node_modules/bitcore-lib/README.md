...
A pure and powerful JavaScript Bastoji library.

## Principles

Bastoji is a powerful new peer-to-peer platform for the next generation of financial technology. The decentralized nature of the Bastoji network allows for highly resilient bastoji infrastructure, and the developer community needs reliable, open-source tools to implement bastoji apps and services.
