# Public Key
Represents a bastoji public key and is needed to be able to receive bastoji, as is usually represented as a bastoji [Address](address.md). See the official [Bastoji Wiki](https://en.bastoji.it/wiki/Technical_background_of_version_1_Bastoji_addresses).
...
A public key point should be on the [secp256k1](https://en.bastoji.it/wiki/Secp256k1) curve, instantiating a new PublicKey will validate this and will throw an error if it's invalid. To check that a public key is valid:
