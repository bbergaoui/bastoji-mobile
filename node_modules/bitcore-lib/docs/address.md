# Bastoji Address
Represents a bastoji address. Addresses are the most popular way to make bastoji transactions. See [the official Bastoji Wiki](https://en.bastoji.it/wiki/Address) for technical background information.

## Instantiate an Address
To be able to receive bastojis an address is needed, but in order to spend them a private key is necessary. Please take a look at the [`PrivateKey`](privatekey.md) docs for more information about exporting and saving a key.  
