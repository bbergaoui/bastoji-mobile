...
var x509 = {
  ...
  pem: ''
    ...
    + 'Qnk4TzY0Ukxwc1F2ZC9oeDFGV0ZSK3g5VXoyUjlXM1ZDU2ROb0VIc3BTJmJMR0FpY25XVDh6VS84'
...
describe('PaymentProtocol', function() {
  ...
  describe('#PaymentACK', function() {
    ...
    it('makePaymentACK', function() {
      ...
      contentType.should.equal(PaymentProtocol.LEGACY_PAYMENT['BTJ'].ACK_CONTENT_TYPE);
  ...
  describe('#getContentType', function() {
    ...
    it('should get a content type for payment', function() {
      ...
      paypro.makePayment();
      paypro.set('memo', 'test memo');
      paypro.getContentType().should.equal('application/bastoji-payment');
    });
  ...
  describe('#serializeForSig', function() {
    ...
    it('should serialize a PaymentRequest and not fail', function() {
      ...
      contentType.should.equal(PaymentProtocol.LEGACY_PAYMENT['BTJ'].REQUEST_CONTENT_TYPE);
      valid.should.equal(true);
