...
PaymentProtocol.LEGACY_PAYMENT.BTJ.REQUEST_CONTENT_TYPE = 'application/bastoji-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.BTJ.CONTENT_TYPE = 'application/bastoji-payment';
PaymentProtocol.LEGACY_PAYMENT.BTJ.ACK_CONTENT_TYPE = 'application/bastoji-paymentack';

PaymentProtocol.LEGACY_PAYMENT.BCH.REQUEST_CONTENT_TYPE = 'application/bastojicash-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.BCH.CONTENT_TYPE = 'application/bastojicash-payment';
PaymentProtocol.LEGACY_PAYMENT.BCH.ACK_CONTENT_TYPE = 'application/bastojicash-paymentack';
...
PaymentProtocol.prototype.makePaymentRequest = function(obj, currency) {
  ...
  this.currency = this.currency || currency || 'BTJ';
  this.setObj(obj);
  return this;
};
...
function magicHash(str) {
  var magicBytes = new Buffer('Bastoji Signed Message:\n');
