...
describe('client API', function() {
  ...
  describe('Wallet Creation', function() {
    ...
    it('should create Bastoji Cash wallet', function(done) {
      clients[0].seedFromRandomWithMnemonic({
        coin: 'bch'
      });
  ...
  describe('Network fees', function() {
    it('should get current fee levels for BTJ', function(done) {
  ...
  describe('Payment Protocol', function() {
    ...
    describe('1-of-1 BCH wallet', function() {
      ...
      // note this is using BCH with BTJ format testnet address
      beforeEach(function(done) {
        http = sinon.stub();
