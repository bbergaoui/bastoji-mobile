...
//console.log('[paypro.js.21]', k,v); //TODO
  ...
  it('Make a PP request with browser', function(done) {
    ...
    PayPro.get({
      ...
      headers['Accept'].should.equal('application/bastoji-paymentrequest');
  ...
  it('Make a PP request with browser BCH', function(done) {
    ...
    PayPro.get({
      ...
      should.not.exist(err);
      headers['Accept'].should.equal('application/bastojicash-paymentrequest');
  ...
  it('Send a PP payment (browser, BTJ)', function(done) {
    var data = TestData.payProData;
    var opts = {
    ...
    var payment = PayPro.send(opts, function(err, data) {
      headers['Accept'].should.equal('application/bastoji-paymentack');
      headers['Content-Type'].should.equal('application/bastoji-payment');
      should.not.exist(err);
      done();
    });
  });
  ...
  it('Send a PP payment (browser, BCH)', function(done) {
    ...
    var payment = PayPro.send(opts, function(err, data) {
      headers['Accept'].should.equal('application/bastojicash-paymentack');
      headers['Content-Type'].should.equal('application/bastojicash-payment');
      should.not.exist(err);
      done();
    });
  });
