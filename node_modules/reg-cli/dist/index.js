...
var compareImages = function compareImages(emitter, _ref2) {
  ...
  return _bluebird2.default.map(images, function (image) {
    ...
    if (p) {
      return p.run(_extends({}, dirs, { image: image, thresholdRate: thresholdRate, thresholdPixel: thresholdPixel, enableAntialias: enableAntialias }));
    }
...
var updateExpected = function updateExpected(_ref3) {
  ...
  return copyImages([].concat(_toConsumableArray(newImages), _toConsumableArray(diffItems)), { actualDir: actualDir, expectedDir: expectedDir, diffDir: diffDir }).then(function () {
