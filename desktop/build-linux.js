...
const resourceFolder = './resources/copay/linux';
const destinationFolder = './desktop/Copay/linux64';

var output = fs.createWriteStream('./desktop/Copay-linux.zip');
...
async function start() {
  try {
    ...
    archive.pipe(output);
    archive.directory(destinationFolder + '/', 'Copay-linux');
    archive.finalize();
  } catch (err) {
    console.error(err);
  }
